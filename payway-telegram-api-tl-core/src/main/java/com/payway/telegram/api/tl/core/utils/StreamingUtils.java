...
import com.payway.telegram.api.tl.core.TLBoolFalse;
import com.payway.telegram.api.tl.core.TLBoolTrue;
import com.payway.telegram.api.tl.core.TLBytes;
import com.payway.telegram.api.tl.core.TLContext;
import com.payway.telegram.api.tl.core.TLIntVector;
...
public class StreamingUtils {
    ...
    /**
     * Writing tl-method to stream. Same as writeTLObject, but used for pretty
     * code
     *
     * @param v tl-method
     * @param stream destination stream
    ...
    /**
     * Reading tl-method from stream. Same as readTLObject, used for pretty
     * code.
     *
     * @param stream source stream
