...
/**
 * TypeLanguage context object. It performs deserialization of objects and
 * vectors. All known classes might be registered in context for
 * deserialization. Often this might be performed from inherited class in init()
 * method call. If TL-Object contains static int field CLASS_ID, then it might
 * be used for registration, but it uses reflection so it might be slow in some
 * cases. It recommended to manually pass CLASS_ID to registerClass method.
 *
 * @author
 * @created 07.12.2015
 */
