...
public class TLUserForeign extends TLAbstractUser { 

public static final int CLASS_ID = 123533224;
...
public TLUserForeign (int id, String firstName, String lastName, String username, long accessHash, com.payway.telegram.api.tl.schema.TLAbstractUserProfilePhoto photo, com.payway.telegram.api.tl.schema.TLAbstractUserStatus status) {
this.id = id;
