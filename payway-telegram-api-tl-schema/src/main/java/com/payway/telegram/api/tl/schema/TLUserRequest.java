...
public class TLUserRequest extends TLAbstractUser { 

public static final int CLASS_ID = -640891665;
...
public TLUserRequest (int id, String firstName, String lastName, String username, long accessHash, String phone, com.payway.telegram.api.tl.schema.TLAbstractUserProfilePhoto photo, com.payway.telegram.api.tl.schema.TLAbstractUserStatus status) {
this.id = id;
